...
setwd('/share/projects/SOP/Functional_Analysis/Tongbangzhuo/Phase1/Kegg/')
...
# 2. Read in processed profile table from script Functional_Analysis_Kegg_Pathway_preprocess.Rmd
...
# 3. Pre-process pathway data
## 3.1 Remove the pathways whose abundance are 0 across all samples
...
## 3.4 Filter low abundance pathway
...
head(filtered_pathway_RA_profile_tbl)
nrow(filtered_pathway_RA_profile_tbl)
```
...
## 5.1 Filter low prevalence pathway
