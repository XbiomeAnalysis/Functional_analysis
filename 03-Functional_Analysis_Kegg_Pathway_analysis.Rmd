...
## Read in processed profile table from script Functional_Analysis_Kegg_Pathway_preprocess.Rmd
...
## Pre-process pathway data
### Remove the pathways whose abundance are 0 across all samples
